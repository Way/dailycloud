 ...
 * @class     -   TagModel
 * @file      -   TagModel.php
 * @location  -   ./server/database/model/TagModel.php
 * @package   -   dailyd
 ...
 * (>) DataAccessLayer
 */
class TagModel extends DataAccessModel {
     ...
     * @return Object
     */
    public static function search($by, $fields = null, $order = null, $index = null, $limit = null) {
        $name = self::getClassName();
        return parent::search($name, $by, $fields, $order, $index, $limit);
    }
