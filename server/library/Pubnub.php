...
class Pubnub {
     ...
     */
    function Pubnub($publish_key = 'demo', $subscribe_key = 'demo', $secret_key = false, $ssl = false, $origin = false) {
    ...
    private function _request($request) {
        ...
        return json_decode(@file_get_contents(implode('/', $request), 0, $ctx), true);
    }
    ...
    private static function _encode($part) {
        return implode('', array_map('Pubnub::_encode_char', str_split($part)));
    }
